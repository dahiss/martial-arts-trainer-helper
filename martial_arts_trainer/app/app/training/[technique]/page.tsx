...
export default function TrainingPage() {
  ...
  const currentTechnique = techniqueData[technique as keyof typeof techniqueData]

  if (!currentTechnique) {
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-white mb-4">Technique Not Found</h1>
          <button 
  ...
  return (
    <div className="min-h-screen bg-black">
      <Navigation />
      <TrainingSession technique={currentTechnique} />
    </div>
  )
}
